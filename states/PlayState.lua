--[[
    PlayState Class.
    It is the bulk of the game, where the player actually controls the
    bird and avoids pipes. When the player collides with a pipe, we
    should go to the GameOver state, where we then go back to the main menu.
]]
...
function PlayState:update(dt)
    ...
    if gamePause == false then
        ...
        for k, pair in pairs(self.pipePairs) do
            ...
            --be sure to ignore it if it is already been scored
    ...
    elseif love.keyboard.wasPressed('p') and gamePause == true then
        ...
        sounds['pause']:pause()
        --resume the background theme music
        sounds['music']:resume()
    end
